...
An exception can occur for many reasons. Following are some scenarios where an exception occurs:
...
Based on these, we have three categories of Exceptions. You need to understand them to know how exception handling
works in Java.
    ...
    also called as Runtime Exceptions. These include programming bugs, such as logic errors or improper use of an API.
